  ...
  return (
    <Sheet>
      ...
      >
        ...
        <Link
          href="/"
          className="flex items-center gap-2 px-4 py-4 border-b light-border"
        >
          <Image
        ...
        <div className="no-scrollbar flex h-[calc(100vh-80px)] flex-col gap-3 justify-between overflow-y-auto ">
          <SheetClose asChild>
